...
if "%PUBLIC_WEB_BASE_URL%"=="" if not "%P2P_WEB_URL%"=="" set PUBLIC_WEB_BASE_URL=%P2P_WEB_URL%
if "%PUBLIC_WEB_BASE_URL%"=="" set PUBLIC_WEB_BASE_URL=http://127.0.0.1:3000
if "%P2P_SIGNAL_URL%"=="" set P2P_SIGNAL_URL=%PUBLIC_SIGNAL_URL%
if "%P2P_HOST_ID%"=="" set P2P_HOST_ID=coderelay-local-host
if "%P2P_WEB_URL%"=="" set P2P_WEB_URL=%PUBLIC_WEB_BASE_URL%
...
echo   Host management: http://127.0.0.1:%PORT%/host
